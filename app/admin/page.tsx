      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <Link href="/admin/accounts" className="group">
            <div className="bg-white rounded-lg shadow-md p-6 transition-all duration-300 group-hover:shadow-lg">
              <div className="flex items-center mb-4">
                <div className="bg-blue-100 p-3 rounded-lg mr-4">
                  <FiDatabase className="h-6 w-6 text-blue-600" />
                </div>
                <h3 className="text-lg font-medium text-gray-900">Kelola Akun</h3>
              </div>
          ...
          <Link href="/admin/orders" className="group">
            <div className="bg-white rounded-lg shadow-md p-6 transition-all duration-300 group-hover:shadow-lg">
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-lg font-medium text-gray-900">Pesanan</h3>
              </div>
              <p className="text-gray-600 mb-4">
          ...
          <Link href="/admin/users" className="group">
            <div className="bg-white rounded-lg shadow-md p-6 transition-all duration-300 group-hover:shadow-lg">
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-lg font-medium text-gray-900">Pengguna</h3>
              </div>
              <p className="text-gray-600 mb-4">
          ...
          <Link href="/admin/settings" className="group">
            <div className="bg-white rounded-lg shadow-md p-6 transition-all duration-300 group-hover:shadow-lg">
              ...
              <span className="text-gray-600 text-sm font-medium group-hover:underline">
                Buka Pengaturan
              </span>
            </div>
          </Link>
        ...
        <div className="mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <Link href="/admin/chat" className="bg-white overflow-hidden shadow rounded-lg p-6 hover:shadow-md transition-shadow">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-sm text-gray-500">Manage customer chat support</p>
                </div>
              </div>
            </Link>
          </div>
